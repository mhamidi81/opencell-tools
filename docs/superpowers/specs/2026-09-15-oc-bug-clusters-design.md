...
|--------|------|---------|-------|
| Enabler | `10076` | `Bug clusters — Frontend — 2026-08-16 → 2026-09-16` | component `Frontend`/`Backend`, marker label, description = window + filters + cluster overview + local report path |
| Sub-task | `10003` | `<subject> — N bugs` | `parent` = the Enabler, description = every bug key and summary |
