---
description: Evaluate Opencell backend code changes against the project guidelines using the oc-be-pr-reviewer agent. Reviews uncommitted changes, a specific Bitbucket PR, or lets you pick from open PRs.
