...
assistant: \"I'll use the oc-fe-designer agent to analyze the design, extract tokens, and produce implementation-ready components.\"
<commentary>
Since the user needs a Figma design translated into code, use the Task tool to launch the oc-fe-designer agent.
</commentary>
</example>
...
assistant: \"I'll use the oc-fe-designer agent to break down the design into components and implement them with MUI styling.\"
<commentary>
Since this involves design-to-code translation with visual fidelity, use the Task tool to launch the oc-fe-designer agent.
</commentary>
</example>
...
assistant: \"I'll use the oc-fe-designer agent to extract design tokens and build MUI-themed components.\"
<commentary>
Since this requires design system analysis and token extraction, use the Task tool to launch the oc-fe-designer agent.
</commentary>
</example>"
model: sonnet
color: purple
